...
namespace WebApplication1.Models.DbDiagram
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="aspnet-WebApplication1-20220824032757")]
	public partial class databasediagramDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertRentalInfoe(RentalInfoe instance);
    partial void UpdateRentalInfoe(RentalInfoe instance);
    partial void DeleteRentalInfoe(RentalInfoe instance);
    partial void InsertUser(User instance);
    partial void UpdateUser(User instance);
    partial void DeleteUser(User instance);
    #endregion
		
		public databasediagramDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["aspnet_WebApplication1_20220824032757ConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public databasediagramDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public databasediagramDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public databasediagramDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public databasediagramDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<RentalInfoe> RentalInfoes
		{
			get
			{
				return this.GetTable<RentalInfoe>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Bikes")]
	public partial class Bike : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<RentalInfoe> _RentalInfoes;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnBikeIDChanging(int value);
    ...
    partial void OnPricePerHourChanging(float value);
    partial void OnPricePerHourChanged();
    #endregion
		
		public Bike()
		{
			this._RentalInfoes = new EntitySet<RentalInfoe>(new Action<RentalInfoe>(this.attach_RentalInfoes), new Action<RentalInfoe>(this.detach_RentalInfoes));
			this._Parking = default(EntityRef<Parking>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BikeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int BikeID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PricePerHour", DbType="Real NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bike_RentalInfoe", Storage="_RentalInfoes", ThisKey="BikeID", OtherKey="BikeID")]
		public EntitySet<RentalInfoe> RentalInfoes
		{
			get
			{
				return this._RentalInfoes;
			}
			set
			{
				this._RentalInfoes.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Parking_Bike", Storage="_Parking", ThisKey="ParkingID", OtherKey="ParkingID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		private void attach_RentalInfoes(RentalInfoe entity)
		{
			this.SendPropertyChanging();
			entity.Bike = this;
		}
		
		private void detach_RentalInfoes(RentalInfoe entity)
		{
			this.SendPropertyChanging();
			entity.Bike = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Parkings")]
    ...
    partial void OnSizeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Parking_Bike", Storage="_Bikes", ThisKey="ParkingID", OtherKey="ParkingID")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.RentalInfoes")]
	public partial class RentalInfoe : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _RentalInfoID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnRentalInfoIDChanging(int value);
    partial void OnRentalInfoIDChanged();
    ...
    partial void OnBikeIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RentalInfoID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int RentalInfoID
		{
			get
			{
				return this._RentalInfoID;
			}
			set
			{
				if ((this._RentalInfoID != value))
				{
					this.OnRentalInfoIDChanging(value);
					this.SendPropertyChanging();
					this._RentalInfoID = value;
					this.SendPropertyChanged("RentalInfoID");
					this.OnRentalInfoIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BikeID", DbType="Int NOT NULL")]
		public int BikeID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Bike_RentalInfoe", Storage="_Bike", ThisKey="BikeID", OtherKey="BikeID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Bike Bike
		{
			get
			{
			...
			set
			{
							...
							|| (this._Bike.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.RentalInfoes.Remove(this);
					}
					this._Bike.Entity = value;
					if ((value != null))
					{
						value.RentalInfoes.Add(this);
						this._BikeID = value.BikeID;
					}
					else
					{
						this._BikeID = default(int);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_RentalInfoe", Storage="_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public User User
		{
			get
			{
    ...
    partial void OnRoleChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FullAddress", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_RentalInfoe", Storage="_RentalInfoes", ThisKey="UserID", OtherKey="UserID")]
		public EntitySet<RentalInfoe> RentalInfoes
		{
			get
			{
